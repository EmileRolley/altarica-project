...
contient des états de situations redoutés ainsi que des niveaux critiques.
    \item Après une projection le nouveau controlleur généré ne contient plus de situations critiques
et de situations redoutés.
...
\paragraph{Interprétation des résultats}
\begin{itemize}
    \item Avec 1 défaillance le controleur initial contient 329 états critiques et état redoutés.
    \item Après une première itération le controleur calculé à diminué considérablement les états critiques 
        ...
        En revanche ce controlleur à introduit des deadlock (96) dans le système...
...
\paragraph{Interprétation des résultats}
\begin{itemize}
    \item La controleur initial contient 551 états critiques et situations redoutés.
    \item En itérant le processus de calcul l'etat se stabilise à la 4ème itération, cependant
        le controleur n'est pas correct il contient 107 états critiques, 270 situations redoutés et
        deadlock.
\end{itemize}
...
\paragraph{Interprétation des résultats}
\begin{itemize}
    \item La controleur initial contient 617 états critiques et situations redoutés.
    \item En itérant le processus de calcul l'etat se stabilise à la 3ème itération, cependant
        le controleur n'est pas correct il contient 27 situations redoutés et 27
        deadlock.
\end{itemize}
